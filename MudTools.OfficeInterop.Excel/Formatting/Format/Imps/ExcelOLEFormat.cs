...
/// <summary>
/// 对 Microsoft.Office.Interop.Excel.OLEFormat 的封装实现类
/// </summary>
internal class ExcelOLEFormat : IExcelOLEFormat
{
    #region 属性封装
    /// <summary>
    /// 获取 OLE 对象的程序标识符
    ...
    /// 获取应用程序对象
    /// </summary>
    public IExcelApplication Application => new ExcelApplication(_oleFormat.Application);

    /// <summary>
    /// 获取创建者信息
    /// </summary>
    public int Creator => Convert.ToInt32(_oleFormat.Creator);
    ...
    private MsExcel.OLEFormat _oleFormat;
    private bool _disposedValue;

    /// <summary>
    /// 初始化 ExcelOLEFormat 实例
    /// </summary>
    /// <param name="oleFormat">原始 COM OLEFormat 对象</param>
    internal ExcelOLEFormat(MsExcel.OLEFormat oleFormat)
    {
    ...
    public void Verb(object classType)
    {
        try
        {
            _oleFormat.Verb(classType);
        }
        catch (COMException ex)
        {
