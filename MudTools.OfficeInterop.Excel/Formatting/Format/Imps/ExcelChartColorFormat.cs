...
internal class ExcelChartColorFormat : IExcelChartColorFormat
{
    private MsExcel.ChartColorFormat _chartColorFormat;
    ...
    public int Type => _chartColorFormat.Type;

    public int RGB
    {
        get => _chartColorFormat.RGB;
    }

    public int SchemeColor
    {
        get => _chartColorFormat.SchemeColor;
        set => _chartColorFormat.SchemeColor = value;
    }

    internal ExcelChartColorFormat(MsExcel.ChartColorFormat chartColorFormat)
    {
