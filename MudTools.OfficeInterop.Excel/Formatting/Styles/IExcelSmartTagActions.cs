...
public interface IExcelSmartTagActions : IOfficeObject<IExcelSmartTagActions, MsExcel.SmartTagActions>, IEnumerable<IExcelSmartTagAction?>, IDisposable
{
    /// <summary>
    /// 获取智能标记动作集合中的动作数量
    /// 对应 SmartTagActions.Count 属性
    /// </summary>
    int Count { get; }
