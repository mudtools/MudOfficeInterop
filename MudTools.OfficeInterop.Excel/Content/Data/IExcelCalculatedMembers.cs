...
public interface IExcelCalculatedMembers : IOfficeObject<IExcelCalculatedMembers, MsExcel.CalculatedMembers>, IEnumerable<IExcelCalculatedMember>, IDisposable
{
    /// <summary>
    /// 获取所属的父对象。
    /// </summary>
