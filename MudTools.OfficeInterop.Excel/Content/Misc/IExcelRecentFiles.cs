...
public interface IExcelRecentFiles : IOfficeObject<IExcelRecentFiles, MsExcel.RecentFiles>, IEnumerable<IExcelRecentFile?>, IDisposable
{
    #region 基础属性
    /// <summary>
    ...
    /// 向最近使用的文件列表中添加一个文件
    /// </summary>
    /// <param name="name">要添加的文件的完整路径</param>
