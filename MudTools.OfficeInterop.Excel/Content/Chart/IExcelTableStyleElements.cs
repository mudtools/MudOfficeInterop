...
public interface IExcelTableStyleElements : IOfficeObject<IExcelTableStyleElements, MsExcel.TableStyleElements>, IEnumerable<IExcelTableStyleElement>, IDisposable
{
    /// <summary>
    /// 获取该对象的父对象
    /// </summary>
