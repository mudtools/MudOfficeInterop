...
public interface IExcelPivotTable : IDisposable
{
    ...
    /// </summary>
    object SourceData { get; } // 可以是 string, Range 等
    ...
    /// </summary>
    IExcelTableStyle TableStyle { get; set; } // 使用占位符
    ...
    void ApplyAutoFormat(int format = 1); // xlRangeAutoFormatClassic1 = 1
    #endregion
