...
/// <summary>
/// 对 Microsoft.Office.Core.PickerField 的二次封装实现类。
/// 提供安全访问选取器字段属性的方式，并管理 COM 对象生命周期。
/// </summary>
internal class OfficePickerField : IOfficePickerField
{
    ...
    /// <summary>
    /// 构造函数，初始化封装的 PickerField 对象。
    /// </summary>
    /// <param name="pickerField">原始的 COM PickerField 对象。</param>
    internal OfficePickerField(MsCore.PickerField pickerField)
    {
        _pickerField = pickerField ?? throw new ArgumentNullException(nameof(pickerField));
    ...
    public string Name
    {
        get => _pickerField?.Name ?? string.Empty;
    }
    ...
    {
        get => _pickerField?.IsHidden ?? false;
    }
