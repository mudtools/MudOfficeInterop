...
/// <summary>
/// 对 Microsoft.Office.Core.ScopeFolder 的二次封装实现类。
/// 提供安全访问搜索范围文件夹属性和方法的方式，并管理 COM 对象生命周期。
/// </summary>
internal class OfficeScopeFolder : IOfficeScopeFolder
{
    ...
    /// <summary>
    /// 构造函数，初始化封装的 ScopeFolder 对象。
    /// </summary>
    /// <param name="scopeFolder">原始的 COM ScopeFolder 对象。</param>
    internal OfficeScopeFolder(MsCore.ScopeFolder scopeFolder)
    {
        _scopeFolder = scopeFolder ?? throw new ArgumentNullException(nameof(scopeFolder));
    ...
    /// <inheritdoc/>
    public string Name => _scopeFolder?.Name ?? string.Empty;
    ...
    public void AddToSearchFolders()
    {
        ...
        _scopeFolder.AddToSearchFolders();
    }
