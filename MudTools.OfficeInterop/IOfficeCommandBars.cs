...
public interface IOfficeCommandBars : IDisposable, IEnumerable<IOfficeCommandBar>
{
    /// <summary>
    /// 获取命令栏集合中的命令栏数量
    /// </summary>
    ...
    /// 根据索引获取命令栏
    /// </summary>
    /// <param name="index">命令栏索引或名称</param>
    /// <returns>命令栏对象</returns>
    IOfficeCommandBar GetItem(object index);
    ...
    /// 查找内置命令栏
    /// </summary>
    /// <param name="id">内置命令栏ID</param>
    /// <returns>命令栏对象</returns>
    IOfficeCommandBarControl FindControl(int id);
    ...
    /// <param name="id">内置命令栏ID</param>
    /// <returns>命令栏对象</returns>
    IOfficeCommandBarControls FindControls(int id);
