...
public interface IOfficeCommandBarControls : IOfficeObject<IOfficeCommandBarControls, MsCore.CommandBarControls>, IDisposable, IEnumerable<IOfficeCommandBarControl?>
{
    /// <summary>
    /// 获取控件集合中的控件数量
    /// </summary>
