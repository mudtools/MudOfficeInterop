...
[ItemIndex]
public interface IOfficeFileDialogFilters : IOfficeObject<IOfficeFileDialogFilters, MsCore.FileDialogFilters>, IEnumerable<IOfficeFileDialogFilter?>, IDisposable
{
    #region 基础属性
    /// <summary>
    /// 获取文件对话框过滤器集合中的过滤器数量
