...
public interface IOfficeCustomXMLSchemaCollection : IOfficeObject<IOfficeCustomXMLSchemaCollection, MsCore.CustomXMLSchemaCollection>, IEnumerable<IOfficeCustomXMLSchema?>, IDisposable
{
    /// <summary>
