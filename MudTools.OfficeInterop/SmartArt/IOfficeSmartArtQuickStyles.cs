...
/// <summary>
/// 表示 Office 中 SmartArt 快速样式集合的接口封装。
/// 该接口提供对 SmartArt 快速样式集合的访问和管理。
/// </summary>
[ComCollectionWrap(ComNamespace = "MsCore")]
public interface IOfficeSmartArtQuickStyles : IOfficeObject<IOfficeSmartArtQuickStyles, MsCore.SmartArtQuickStyles>, IEnumerable<IOfficeSmartArtQuickStyle?>, IDisposable
{
    /// <summary>
