...
public interface IPowerPointRotationEffect : IOfficeObject<IPowerPointRotationEffect, MsPowerPoint.RotationEffect>, IDisposable
{
    ...
    /// 获取此旋转效果的父对象。
    /// </summary>
    /// <value>表示此旋转效果父对象的 <see cref="object"/>。</value>
    object? Parent { get; }

    /// <summary>
    /// 获取或设置旋转效果的相对旋转角度（以度为单位）。
    /// </summary>
    /// <value>表示相对旋转角度的浮点数。</value>
    float By { get; set; }

    /// <summary>
    /// 获取或设置旋转效果的起始旋转角度（以度为单位）。
    /// </summary>
    /// <value>表示起始旋转角度的浮点数。</value>
    float From { get; set; }

    /// <summary>
    /// 获取或设置旋转效果的目标旋转角度（以度为单位）。
    /// </summary>
    /// <value>表示目标旋转角度的浮点数。</value>
    float To { get; set; }
}