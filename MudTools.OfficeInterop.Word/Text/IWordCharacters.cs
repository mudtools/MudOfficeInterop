...
public interface IWordCharacters : IEnumerable<IWordRange>, IDisposable
{
    ...
    /// <returns>找到的字符范围，未找到返回null。</returns>
    IWordRange Find(string findText, bool forward = true, MsWord.WdFindWrap wrap = MsWord.WdFindWrap.wdFindStop,
