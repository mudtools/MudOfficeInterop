...
/// 表示 Word 单词集合的封装接口。
/// </summary>
public interface IWordWords : IEnumerable<IWordRange>, IDisposable
{
    /// <summary>
    /// 获取应用程序对象。
    /// </summary>
    ...
    /// <returns>找到的单词范围，未找到返回null。</returns>
    ...
    int GetSentenceCount(int startIndex, int length);
}