...
/// <summary>
/// 表示所有有效字体名称的列表。
/// <para>注：FontNames 对象是只读的，不能在列表中添加或删除名称。</para>
...
public interface IWordFontNames : IEnumerable<string?>, IOfficeObject<IWordFontNames, MsWord.FontNames>, IDisposable
{
    /// <summary>
    /// 获取与该对象关联的 Word 应用程序。
    /// </summary>
