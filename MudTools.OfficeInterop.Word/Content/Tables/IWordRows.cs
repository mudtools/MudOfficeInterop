...
public interface IWordRows : IEnumerable<IWordRow?>, IOfficeObject<IWordRows>, IDisposable
{
    /// <summary>
    /// 获取应用程序对象。
    /// </summary>
    ...
    /// <summary>
    /// 获取或设置 Microsoft Word 在指定表格或行中排序单元格的方向。
    /// </summary>
    WdTableDirection TableDirection { get; set; }


    /// <summary>
    /// 返回表示集合中第一个项目的 Row 对象。
    /// </summary>
    IWordRow? First { get; }

    /// <summary>
    /// 返回作为 Row 对象的 Rows 集合中的最后一个项目。
    /// </summary>
    IWordRow? Last { get; }
    ...
    /// <returns>Microsoft.Office.Interop.Word.Row</returns>
    ...
    /// <param name="heightRule">必需 WdRowHeightRule。确定指定行高度的规则。可以是以下 WdRowHeightRule 常量之一：wdRowHeightAtLeast、wdRowHeightExactly、wdRowHeightAuto。</param>
