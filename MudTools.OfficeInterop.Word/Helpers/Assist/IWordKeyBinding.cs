...
public interface IWordKeyBinding : IDisposable
{
    ...
    /// 重新绑定组合键到新的命令。
    /// </summary>
    /// <param name="keyCategory">组合键的类别，指定要绑定的命令类型</param>
    /// <param name="command">要绑定的命令、内置函数、宏、字体、自动图文集词条、样式或符号</param>
    /// <param name="commandParameter">可选的命令参数，用于传递给命令的附加参数</param>
    void Rebind(WdKeyCategory keyCategory, string command, string? commandParameter);
