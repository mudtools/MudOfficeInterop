...
/// <summary>
/// 使用 Microsoft.Office.Interop.Word.Shape 或 Microsoft.Office.Interop.Word.ShapeRange 对象的 WidthRelative 属性指定的值来指定形状的相对宽度
/// </summary>
public enum WdRelativeHorizontalSize
{
    ...
    /// <summary>
    /// 宽度相对于内侧边距的大小——奇数页相对于左边距的大小，偶数页相对于右边距的大小
    /// </summary>
    wdRelativeHorizontalSizeInnerMarginArea,

    /// <summary>
    /// 宽度相对于外侧边距的大小——奇数页相对于右边距的大小，偶数页相对于左边距的大小
    /// </summary>
